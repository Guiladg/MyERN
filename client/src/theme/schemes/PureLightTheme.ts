import { alpha, createTheme, lighten, darken, responsiveFontSizes } from '@mui/material';
...
const colors = {
	...
	secondary: {
		...
		light: lighten(themeColors.secondary, 0.4),
		main: themeColors.secondary,
		dark: darken(themeColors.secondary, 0.2)
	},
	primary: {
		lighter: lighten(themeColors.primary, 0.85),
		light: lighten(themeColors.primary, 0.4),
		main: themeColors.primary,
		dark: darken(themeColors.primary, 0.2)
	},
	success: {
		lighter: lighten(themeColors.success, 0.85),
		light: lighten(themeColors.success, 0.4),
		main: themeColors.success,
		dark: darken(themeColors.success, 0.2)
	},
	warning: {
		lighter: lighten(themeColors.warning, 0.85),
		light: lighten(themeColors.warning, 0.4),
		main: themeColors.warning,
		dark: darken(themeColors.warning, 0.2)
	},
	error: {
		lighter: lighten(themeColors.error, 0.85),
		light: lighten(themeColors.error, 0.4),
		main: themeColors.error,
		dark: darken(themeColors.error, 0.2)
	},
	info: {
		lighter: lighten(themeColors.info, 0.85),
		light: lighten(themeColors.info, 0.4),
		main: themeColors.info,
		dark: darken(themeColors.info, 0.2)
	}
};

export const PureLightTheme = responsiveFontSizes(
	createTheme(
		{
			colors: {
				gradients: {
				...
				MuiList: {
					styleOverrides: {
						root: {
							...
							'& .MuiListItemButton-root.MuiButtonBase-root.Mui-selected': {
